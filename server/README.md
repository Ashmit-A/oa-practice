...
Set `MONGODB_URI` to MongoDB Atlas, `CLIENT_URL` to your Vercel URL, and `GEMINI_API_KEY` to a Google Gemini API key. Judge0 defaults to the public CE endpoint.
...
- Google Gemini (`gemini-2.5-flash`) to convert raw GFG HTML into clean descriptions, constraints, examples, and STDIN-ready sample cases

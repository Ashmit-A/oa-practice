const statusStyles = {
  ...
  unavailable: 'bg-stone-500/20 text-stone-300 border-stone-500/30',
};
...
export default function PermissionStatus({
  ...
  return (
    <div className="flex items-center justify-between rounded-lg border border-stone-800 bg-stone-950/60 px-3 py-2">
